...
class TannerGNN(nn.Module):
    ...
    The corrections are added to the channel LLR before BP:
        corrected_llr = channel_llr + gnn_output
    """
    ...
    def forward(self, data) -> torch.Tensor:
        ...
        Returns:
            llr_correction: (n_data,) per-data-qubit LLR correction
        """
        ...
        llr_correction = self.readout(data_embeddings).squeeze(-1)  # (n_data,)

        return llr_correction
